...
const tag = [
  { image: Imghome1, title: "Soup" },
  { image: Imghome2, title: "Chicken" },
  { image: Imghome3, title: "Seafood" },
  { image: Imghome2, title: "Dessert" },
];
  ...
  const renderItemRecipe = ({ item }) => (
    <View>
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate("DetailsRecipe", { id: item.id })}
      >
        <Image
